...
To use this model via the Replicate API:

```python
import replicate

# Example: Convert a JPG to PNG
output = replicate.run(
    "your-username/professional-document-suite:version_hash",
    input={
        "input_files": ["path/to/your/image.jpg"],
        "operation": "image_jpg_to_png"
    }
)
```
